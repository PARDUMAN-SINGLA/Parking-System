...
public:
    ...
    int id_no;
    friend class location; // friend class can access private and protected members of other class in which it is declared as friend.
    friend class Floor;    // friend class
    ...
    void get_E_slip()
    {
        ...
        if (type_of_vehicle == 2)
        {
            cout << "\t\t\t\t           Two Wheeler Parking Ticket" << endl;
            cout << "\t\t\t\t         Location: 1st floor" << endl;
        }
        ...
        else if (type_of_vehicle == 4)
        {
            if (is_self_drive)
            {
                cout << "\t\t\t\t           Four Wheeler Parking Ticket" << endl;
                cout << "\t\t\t\t         Location: 2nd floor" << endl;
            }
            else
            {
                cout << "\t\t\t\t           Four Wheeler Parking Ticket" << endl;
                cout << "\t\t\t\t         Location: 3rd floor" << endl;
            }
        }
        cout << "\t\t\t\t         Coordinates: (" << of_this_vehicle.x << "," << of_this_vehicle.y << ")" << endl
             << endl;
        cout << "\t\t\t\t         Vehicle Number      : " << vehicle_no << endl;
        cout << "\t\t\t\t         Mobile Number       : " << phone_no << endl;
        cout << "\t\t\t\t         Id                  : " << id_no << endl;
        cout << endl;
...
{ // by reference so that we can change the values of componenets of object datum
    location now;
    now.Floor_no = datum;
    int flag = 0;
    ...
    for (int i = 1; i <= 10 && flag == 0; i++)
    {
        for (int j = 1; j <= 10 && flag == 0; j++)
        {
            int c = rand() % (10 + 2);
            int d = rand() % (10 + 2);
            if (datum.visited[c][d] != 0)
            {
                continue;
            }
            else
            {
                datum.visited[c][d] = id;
                now.x = c;
                now.y = d;
                flag = 1;
            }
...
void display(Floor W)
{
    ...
    for (int i = 1; i <= 10; i++)
    {
        ...
        {
            if (W.visited[i][j] != 0)
                cout << COLOR_GREEN << W.visited[i][j] << "  " << COLOR_RESET;
            else
                cout << W.visited[i][j] << "  ";
        }
        cout << endl;
...
int main()
{
    ...
    {
        cout << endl
             << "\t\t\tPlease select an option to proceed further" << endl;
        ...
        else if (t == 1)
        {
            ...
            {
                cout << endl
                     << "\t\t\tSelect the type of your Vehicle" << endl;
                ...
                else
                {
                    ...
                    // it will help us reallocate the space as it will search for 0 only
                    //  first available parking lot and it will return its location
                    if (type_of_vehicle == 2)
                    {
                        // floor - a.f1
